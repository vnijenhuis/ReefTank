...
namespace ReefTank.Web.Areas.Migrations.Controllers
{
    public class MigrateController : Controller
    {
        ...
        public MigrateController(IRepository<Category> categoryRepository, IRepository<Subcategory> subcategoryRepository, IRepository<Creature> creatureRepository, IRepository<Tag> tagRepository, IRepository<Genus> genusRepository)
        {
            ...
            var tags = new[]
{
            ...
            tags.ForEach(x => _tagRepository.Add(x));
            var caution = new[]
            {
                new Tag()
                {
            ...
            caution.ForEach(x => _tagRepository.Add(x));
            ...
            warnings.ForEach(x => _tagRepository.Add(x));
            ...
            categories.ForEach(x => _categoryRepository.Add(x));
            ...
            crustaceans.ForEach(x => _subcategoryRepository.Add(x));
            echinoderms.ForEach(x => _subcategoryRepository.Add(x));
            fish.ForEach(x => _subcategoryRepository.Add(x));
            molluscs.ForEach(x => _subcategoryRepository.Add(x));
            corals.ForEach(x => _subcategoryRepository.Add(x));
            ...
            _creatureRepository.Add(a);

            creatures.ForEach(x => _creatureRepository.Add(x));
